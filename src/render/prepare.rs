use crate::{
    world::{elevation::WorldElevationData, tectonics::WorldTectonicsData, HexWorldMapMode},
    render::{
...
use h3ron::{res0_cells, H3Cell, Index, ToCoordinate, ToPolygon};
...
pub fn prepare(
    ...
    for (hex_world, transform, map_mode, elevation_data, tectonics_data) in hex_world.iter() {
        ...
        commands
            .spawn(HexWorldChunk(0, gpu_mesh))
